...
[Here is a link for more information](https://en.wikipedia.org/wiki/Bash_(Unix_shell))
...
Every user has their own home directory where they have full access to do whatever they want. 
...
began with. This data is located in the `~/Shell_Tutorial/data`
...
Let's navigate back to `~/Shell_Tutorial/data`. Enter the following command:
